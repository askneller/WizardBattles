...
@RegisterPlugin
public class LocalPeakRasterizer implements WorldRasterizerPlugin {
    ...
    public void generateChunk(CoreChunk chunk, Region chunkRegion) {
        LocalPeakFacet facet = chunkRegion.getFacet(LocalPeakFacet.class);

        for (Map.Entry<BaseVector3i, String> entry : facet.getRelativeEntries().entrySet()) {
            BaseVector3i pos = entry.getKey();
            String prefab = entry.getValue();
